...
public class updateActvityDO extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    List<updateChapterDataset> UnDownoaldedchapter  = new ArrayList<>();
    ...
    Button choosepdf,chemistry,physics,maths,dpp,coachingNotes,previousYearQuestion,biology, upload,cbse, upload_thubnail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_actvity_d_o);
            ...
            upload_thubnail = findViewById(R.id.uploadthubnail_chapterActivity);
            ...
            upload_thubnail.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    startActivity(new Intent(getApplicationContext(),upgrade_to_DO_thubnail.class));
                }
            });
        ...
        private void choosefileWindow () {
            AlertDialog.Builder alert = new AlertDialog.Builder(updateActvityDO.this);
            ...
            back.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!temppre.equals(path)) {
                        ...
                        Toast.makeText(updateActvityDO.this, "You Are In Root Directory", Toast.LENGTH_SHORT).show();
        ...
        private void upload(File uri){
            ...
            final ProgressDialog pd = new ProgressDialog(updateActvityDO.this);
            ...
            TransferObserver observer = transferUtility.upload(
                    ...
                    tempsub+"/"+tempbook+"/"+currentChapter,
                    uri
            ...
            observer.setTransferListener(new TransferListener() {
                ...
                public void onStateChanged(int id, TransferState state) {
                    if (state.COMPLETED.equals(observer.getState())) {
                        ...
                        chapterDataset dataset = new chapterDataset(DownloadKey,currentTime,currentCHNo);
                        db.collection(currentsub).document(currentBook).collection("Chapters").document(currentChapter).set(dataset).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(updateActvityDO.this, "upload Completed", Toast.LENGTH_SHORT).show();
                                pd.dismiss();
                            ...
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(updateActvityDO.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
        ...
        db.collection(currentsub).document(currentBook).collection("Chapters").orderBy("timeStamp", Query.Direction.ASCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                for (QueryDocumentSnapshot data : task.getResult()) {
                    listName.add(data.getId());
                    chapterDataset dataset = data.toObject(chapterDataset.class);
                    UnDownoaldedchapter.add(new updateChapterDataset(data.getId(),dataset.getTimeStamp(), dataset.getChapterNo(), dataset.getUrl()));
                }

                ArrayAdapter<String> arradp = new ArrayAdapter<>(updateActvityDO.this,R.layout.support_simple_spinner_dropdown_item,listName);
                chapterSpinner.setAdapter(arradp);
                chapterSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    @Override
                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                        showDetails.setText("Name : "+UnDownoaldedchapter.get(i).getName()+"\n"+"Chapter No : "+UnDownoaldedchapter.get(i).getChapterNo());
                        currentChapter = UnDownoaldedchapter.get(i).getName();
                        currentTime = UnDownoaldedchapter.get(i).getTimestemp();
                        currentCHNo = UnDownoaldedchapter.get(i).getChapterNo();
                    }
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(updateActvityDO.this, "FAILED : error while loading data", Toast.LENGTH_SHORT).show();
            }
        });
    }
