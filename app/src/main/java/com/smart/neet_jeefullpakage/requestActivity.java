...
public class requestActivity extends AppCompatActivity {
    private final String TAG = "RequestActivity".getClass().getSimpleName();
    EditText msg;
    Button ok;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msg = findViewById(R.id.msg_Request);
        ok = findViewById(R.id.send_Request);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String uriText = "mailto:" + Uri.encode(" sk1421751@gmail.com") +
                        "?subject=" + Uri.encode("Request For Books") +
